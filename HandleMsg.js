...
module.exports = HandleMsg = async (pakforlay, message) => {
            ...
            if (isOwnerBot) {
                await pakforlay.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await pakforlay.sendText(chekgrup.id, `Hai minna~, Im GUS BOT. To find out the commands on this bot type ${prefix}menu`)
                      })
            } else {
	...
	case 'twimg':
            ...
            await pakforlay.sendFileFromUrl(from, twimg, 'Sukses mengunduh Foto Twitter Menggunakan Bot WhatsApp Gus', '', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
        case 'twvid':
            ...
            await pakforlay.sendFileFromUrl(from, twvid, 'Sukses mengunduh Video Twitter Menggunakan Bot WhatsApp Gus', '', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
        case 'insta':
		case 'ig':
            ...
            await pakforlay.sendFileFromUrl(from, instag, 'Sukses mengunduh Foto/Video Instagram Menggunakan Bot WhatsApp Gus', '', id)
            .catch(() => {
                pakforlay.reply(from, 'Ada yang Error!', id)
            })
            break
		...
		case 'ytvid':
            ...
            await pakforlay.sendFileFromUrl(from, youtube, `Sukses mengunduh Video Youtube Menggunakan Bot WhatsApp Gus`, id)
            .catch(() => {
		...
		*/
        ...
        case 'bc': //untuk broadcast atau promosi
            ...
            for (let idk of chatz) {
                ...
                if (!cvk.isReadOnly) pakforlay.sendText(idk, `〘 *GusBot  B C* 〙\n\n${msg}`)
                if (cvk.isReadOnly) pakforlay.sendText(idk, `〘 *GusBot  B C* 〙\n\n${msg}`)
            }
